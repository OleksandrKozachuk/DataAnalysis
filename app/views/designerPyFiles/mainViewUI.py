...
"")
        ...
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(8), self.dockWidgetProtocol)
        ...
        self.toolBar1DAnalysis = QtWidgets.QToolBar(MainWindow)
        self.toolBar1DAnalysis.setWindowTitle("")
        ...
        MainWindow.addToolBar(QtCore.Qt.RightToolBarArea, self.toolBar2DAnalysis)
        self.toolBarMultiDimAnalysis = QtWidgets.QToolBar(MainWindow)
        self.toolBarMultiDimAnalysis.setWindowTitle("")
        self.toolBarMultiDimAnalysis.setObjectName("toolBarMultiDimAnalysis")
        MainWindow.addToolBar(QtCore.Qt.RightToolBarArea, self.toolBarMultiDimAnalysis)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/imgRc/images/minus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionMatrixScatterDiagrams = QtWidgets.QAction(MainWindow)
        self.actionMatrixScatterDiagrams.setObjectName("actionMatrixScatterDiagrams")
        self.actionDiagramParallelCoordinates = QtWidgets.QAction(MainWindow)
        self.actionDiagramParallelCoordinates.setObjectName("actionDiagramParallelCoordinates")
        self.actionBubbleDiagram = QtWidgets.QAction(MainWindow)
        self.actionBubbleDiagram.setObjectName("actionBubbleDiagram")
        self.actionDiagnosticChart = QtWidgets.QAction(MainWindow)
        self.actionDiagnosticChart.setObjectName("actionDiagnosticChart")
        self.actionRegressionAnalysis = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/imgRc/images/regression.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRegressionAnalysis.setIcon(icon11)
        self.actionRegressionAnalysis.setObjectName("actionRegressionAnalysis")
        self.actionPartialCorrelationCoefficient = QtWidgets.QAction(MainWindow)
        self.actionPartialCorrelationCoefficient.setObjectName("actionPartialCorrelationCoefficient")
        self.actionMultipleCorrelationCoefficient = QtWidgets.QAction(MainWindow)
        self.actionMultipleCorrelationCoefficient.setObjectName("actionMultipleCorrelationCoefficient")
        self.actionPCA = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/imgRc/images/PCA.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPCA.setIcon(icon12)
        self.actionPCA.setObjectName("actionPCA")
        self.actionFactorAnalysis = QtWidgets.QAction(MainWindow)
        icon13 = QtGui.QIcon()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionMatrixScatterDiagrams.setText(_translate("MainWindow", "Матриця діаграм розкиду"))
        self.actionDiagramParallelCoordinates.setText(_translate("MainWindow", "Діаграма паралельних координат"))
        self.actionBubbleDiagram.setText(_translate("MainWindow", "Бульшакова діаграма"))
        self.actionDiagnosticChart.setText(_translate("MainWindow", "Діагностична діаграма"))
        self.actionRegressionAnalysis.setText(_translate("MainWindow", "Регресійний аналіз"))
        self.actionPartialCorrelationCoefficient.setText(_translate("MainWindow", "Частковий коефіцієнт кореляції"))
        self.actionMultipleCorrelationCoefficient.setText(_translate("MainWindow", "Множинний коефіцієнт кореляції"))
